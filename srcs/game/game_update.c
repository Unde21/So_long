...
/*   Updated: 2025/02/13 16:08:00 by samaouch         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
void	landing_spaceship(t_data *data)
{
	...
	if (data->player->frames >= LANDING_FRAME)
	{
		...
		{
			if (data->spaceship->final_y >= 1
				&& data->map[data->spaceship->final_y
			...
			else if (data->spaceship->final_y >= 1
				&& data->map[data->spaceship->final_y
				...
				- 1][data->spaceship->pos_x] == 'C')
			{
				...
				&& data->map[data->spaceship->final_y - 1][data->spaceship->pos_x] == 'P')
			{
				mlx_put_image_to_window(data->mlx_ptr, data->win_ptr,
